...
namespace SimplePlayer.MediaInfo
{
    ...
    public static class MediaInfoHelper {
		...
		private static Dictionary<string, KeyValuePair<DateTime, BasicVideoInformation> > information = new Dictionary<string, KeyValuePair<DateTime, BasicVideoInformation> >();
